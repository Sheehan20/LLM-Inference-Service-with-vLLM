    ...
    async def _handle_failure(self):
        ...
        async with self.lock:
            ...
            if self.state == CircuitState.CLOSED:
                ...
                self.state = CircuitState.OPEN
                logger.warning(f"Circuit breaker {self.name} reopened due to failure during recovery")
...
class RequestQueue:
    ...
    def __init__(self, max_size: int = 1000, max_workers: int = None):
        ...
        self.max_workers = max_workers or asyncio.BoundedSemaphore(50)  # Limit concurrent processing
...
class ResilienceManager:
    ...
    def get_request_queue(self, name: str, max_size: int = 1000, max_workers: int = None) -> RequestQueue:
    ...
    def get_all_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "request_queues": {name: queue.get_stats() for name, queue in self.request_queues.items()}
        }
